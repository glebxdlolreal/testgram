...
public class GetPollVotesQueryHandler(IQueryOnlyReadModelStore<PollAnswerVoterReadModel> store)
    : IQueryHandler<GetPollVotesQuery, IReadOnlyCollection<IPollAnswerVoterReadModel>>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await store.FindAsync(predicate, skip: query.Skip, limit: query.Limit,
            cancellationToken: cancellationToken);
    }
}
