...
/// </remarks>
internal sealed class GetEmojiProfilePhotoGroupsHandler(IEmojiGroupsAppService emojiGroupsAppService) : RpcResultObjectHandler<MyTelegram.Schema.Messages.RequestGetEmojiProfilePhotoGroups, MyTelegram.Schema.Messages.IEmojiGroups>
{
    ...
    {
        return emojiGroupsAppService.GetEmojiGroupsAsync(EmojiGroupType.ProfilePhoto, obj.Hash);
    }
}
