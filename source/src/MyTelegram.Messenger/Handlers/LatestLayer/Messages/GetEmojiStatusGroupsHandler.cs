...
/// </remarks>
internal sealed class GetEmojiStatusGroupsHandler(IEmojiGroupsAppService emojiGroupsAppService) : RpcResultObjectHandler<MyTelegram.Schema.Messages.RequestGetEmojiStatusGroups, MyTelegram.Schema.Messages.IEmojiGroups>
{
    ...
    {
        return emojiGroupsAppService.GetEmojiGroupsAsync(EmojiGroupType.Status, obj.Hash);
    }
}
