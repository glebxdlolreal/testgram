...
/// </remarks>
internal sealed class GetEmojiStickerGroupsHandler(IEmojiGroupsAppService emojiGroupsAppService) : RpcResultObjectHandler<MyTelegram.Schema.Messages.RequestGetEmojiStickerGroups, MyTelegram.Schema.Messages.IEmojiGroups>
{
    ...
    {
        return emojiGroupsAppService.GetEmojiGroupsAsync(EmojiGroupType.Stickers, obj.Hash);
    }
}
